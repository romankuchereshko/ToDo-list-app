...
public class GlobalExceptionHandler {
    ...
    public ModelAndView handleAccessDeniedException(AccessDeniedException ex, HttpServletRequest request) throws Exception {
        return getModelAndView(request, HttpStatus.FORBIDDEN, ex);
    }
    /*@ExceptionHandler(UsernameNotFoundException.class)
    @ResponseStatus(value = HttpStatus.BAD_REQUEST)
    public ModelAndView UsernameNotFoundExceptionHandler(HttpServletRequest request, UsernameNotFoundException exception) {
        return getModelAndView(request, HttpStatus.BAD_REQUEST, exception);
    }*/
